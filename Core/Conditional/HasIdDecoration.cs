...
namespace Decoratid.Core.Conditional
{
    ...
    /// </summary>
    [Serializable]
    public class HasIdDecoration<TId> : DecoratedConditionBase, IHasId<TId>
    {
        #region Ctor
        public HasIdDecoration(ICondition decorated, TId id)
            : base(decorated)
        {
            this.Id = id;
        }
    ...
    {
        public static HasIdDecoration<TId> HasId<TId>(this ICondition decorated, TId id)
        {
