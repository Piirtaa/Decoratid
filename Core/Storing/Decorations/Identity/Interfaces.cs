...
namespace Sandbox.Store.Decorations.Identity
{
    ...
    /// <summary>
    /// Is a store that has an id, and is capable of participating in an identity handshake where one store
    /// saves, as a client, information on another store 
    /// </summary>
    public interface IIdentifiableStore : IStore, IHasId<string>
    {
